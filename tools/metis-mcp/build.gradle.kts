...
application {
    mainClass.set("org.tatrman.kantheon.metis.mcp.ApplicationKt")
}
...
jib {
    ...
    to {
        image = "metis-mcp:latest"
    }
    container {
        mainClass = "org.tatrman.kantheon.metis.mcp.ApplicationKt"
        ports = listOf("7262")
    }
    dockerClient {
        executable = "docker"
...
dependencies {
    ...
    // gRPC client to the metis service (Python; stubs generated from shared proto).
