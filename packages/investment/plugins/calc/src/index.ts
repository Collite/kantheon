...
export { twr, mwr, fifo, cashOperation, cashRef, twrFn, mwrFn, fifoFn, cashOperationFn, cashRefFn } from './calc.js';
...
import { twrFn, mwrFn, fifoFn, cashOperationFn, cashRefFn } from './calc.js';
...
export const canonFunctions: Record<string, CanonFunction> = {
  ...
  [mwrFn.id]: mwrFn,
  [fifoFn.id]: fifoFn,
  [cashOperationFn.id]: cashOperationFn,
  [cashRefFn.id]: cashRefFn,
};
