...
{{- define "kantheon-service.fe-configmap" -}}
apiVersion: v1
kind: ConfigMap
metadata:
...
{{- define "kantheon-service.fe-deployment" -}}
apiVersion: apps/v1
kind: Deployment
metadata:
  ...
  template:
    metadata:
      annotations:
        ...
        checksum/config: {{ printf "%s\n" (include "kantheon-service.fe-configmap" .) | sha256sum }}
...
{{- define "kantheon-service.fe-service" -}}
apiVersion: v1
kind: Service
metadata:
  name: {{ include "kantheon-service.fullname" . }}
...
{{- define "kantheon-service.httproute" -}}
